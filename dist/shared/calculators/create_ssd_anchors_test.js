    ...
    it('face detection config.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = parseAnchors;
                    return [4 /*yield*/, fetch("".concat(test_util_2.KARMA_SERVER, "/shared/anchor_golden_file_0.json"))
    ...
    it('3 inputs reverse.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = parseAnchors;
                    return [4 /*yield*/, fetch("".concat(test_util_2.KARMA_SERVER, "/shared/anchor_golden_file_1.json"))
                            .then(function (response) { return response.json(); })];
                case 1:
                    expectedAnchors = _a.apply(void 0, [_b.sent()]);
                    config = {
