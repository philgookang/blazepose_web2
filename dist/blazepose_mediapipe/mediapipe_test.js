...
(0, jasmine_util_1.describeWithFlags)('MediaPipe Pose static image ', jasmine_util_1.BROWSER_ENVS, function () {
    var detector;
    var image;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, test_util_2.loadImage)('pose.jpg', 1000, 667)];
                case 1:
                    image = _a.sent();
                    return [4 /*yield*/, (0, test_util_2.loadImage)('pose_segmentation.png', 1000, 667)];
                case 2:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, mask_util_1.toImageDataLossy)(segmentationImage)];
                case 4:
...
(0, jasmine_util_1.describeWithFlags)('MediaPipe Pose video ', jasmine_util_1.BROWSER_ENVS, function () {
    var detector;
    var timeout;
    var expected;
    var expected3D;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    timeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
                    jasmine.DEFAULT_TIMEOUT_INTERVAL = 120000; // 2mins
                    return [4 /*yield*/, fetch("".concat(test_util_2.KARMA_SERVER, "/pose_squats.full.json"))
                            .then(function (response) { return response.json(); })
                            .then(function (result) { return (0, test_util_2.getXYPerFrame)(result); })];
                case 1:
                    expected = _a.sent();
                    return [4 /*yield*/, fetch("".concat(test_util_2.KARMA_SERVER, "/pose_squats_3d.full.json"))
                            .then(function (response) { return response.json(); })];
                case 2:
                    expected3D = _a.sent();
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, test_util_2.loadVideo)('pose_squats.mp4', 5 /* fps */, callback, expected, poseDetection.util.getAdjacentPairs(model), simulatedInterval)];
                case 2:
                    // Original video source in 720 * 1280 resolution:
                    // https://www.pexels.com/video/woman-doing-squats-4838220/ Video is
                    // compressed to be smaller with less frames (5fps), using below command:
